            ...
            <div className="flex justify-between items-center ">
                ...
                <div className='flex flex-row justify-center items-center space-x-2 gap-1'>
                    <img
                        ...
                        alt="profile"
                    />
<div className='flex justify-center text-white p-2 m-2'> <h1 className='font-semibold justify-center text-white'>{likesNumber}</h1>
            ...
            <img
                src={PostUrl}
                className='h-64 xs:h-[200px] lg:h-[250px] w-full rounded-[24px] object-cover mb-5 mt-5'
            />
            {/* lower */}
